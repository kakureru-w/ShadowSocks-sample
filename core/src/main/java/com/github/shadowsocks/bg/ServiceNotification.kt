...
class ServiceNotification(private val service: BaseService.Interface, profileName: String,
    ...
    private val callback: IShadowsocksServiceCallback by lazy {
        object : IShadowsocksServiceCallback.Stub() {
            ...
            override fun trafficUpdated(profileId: Long, stats: TrafficStats) {
                ...
                builder.apply {
                    setContentText((service as Context).getString(
                        R.string.traffic,
                            service.getString(com.github.shadowsocks.core.R.string.speed, Formatter.formatFileSize(service, stats.txRate)),
                            service.getString(com.github.shadowsocks.core.R.string.speed, Formatter.formatFileSize(service, stats.rxRate))))
                    setSubText(service.getString(
                        R.string.traffic,
    ...
    private val builder = NotificationCompat.Builder(service as Context, channel)
            ...
            .setTicker(service.getString(com.github.shadowsocks.core.R.string.forward_success))
    ...
    init {
        ...
        val closeAction = NotificationCompat.Action.Builder(
            com.github.shadowsocks.plugin.R.drawable.ic_navigation_close,
                service.getText(com.github.shadowsocks.core.R.string.stop),
